...
class Cask:    #Достаем бочонки по 1 штуке
...
#Поиск номера на карточке Лото и определяем победителя
...
sys.exit(1)
if player2.search(game.card_comp, num_cask):
    continue
